...
it('should check if brackets sequence is correct 15', () => {
  assert.equal(check('1111156111111111561111111122228888882222557748777787755556666777777777766222221111222288888822225577877778775555666677777777776622222', config6), true);
});
